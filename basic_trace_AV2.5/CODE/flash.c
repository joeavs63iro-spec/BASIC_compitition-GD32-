...
void flash_init_and_load(void)
{
    ...
    if (flash_box.magic_code == FLASH_MAGIC_FLAG && flash_box.param_version == FLASH_PARAM_VERSION && flash_box.checksum == calculate_checksum(&flash_box))
    {
