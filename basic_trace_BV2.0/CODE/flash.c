...
static uint8_t flash_params_are_valid(const CarParams_t *params)
{
    ...
    if (params->car_role > 1U) return 0U;
    if (params->set_off_count < 1 || params->set_off_count > 300) return 0U;
    if (params->d_park_3 < 0 || params->d_park_3 > 20) return 0U;
    if (params->d_avoid > 5000U || params->d_round_in > 5000U) return 0U;
    if (params->a_avoid_1 > 4095U || params->a_avoid_2 > 4095U ||
        params->a_avoid_3 > 4095U || params->a_round_in > 4095U ||
        params->a_park_1 > 4095U) return 0U;
    if (params->p_avoid_1 > 60000U || params->p_avoid_2 > 60000U ||
        params->p_avoid_3 > 60000U || params->p_round_in > 60000U ||
        params->p_round_out > 60000U || params->p_park_1 > 60000U ||
        params->p_park_2 > 60000U || params->p_park_4 > 60000U) return 0U;
    return 1U;
}
