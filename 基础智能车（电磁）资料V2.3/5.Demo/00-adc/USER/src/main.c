...
int main(void)
{
    ...
    while(1)
    {
			adc_value[0]=adc_convert(ADC0, ADC_CH_10);
			adc_value[1]=adc_convert(ADC0, ADC_CH_11);
			adc_value[2]=adc_convert(ADC0, ADC_CH_12);
			adc_value[3]=adc_convert(ADC0, ADC_CH_13);
			adc_value[4]=adc_convert(ADC0, ADC_CH_14);
    }
