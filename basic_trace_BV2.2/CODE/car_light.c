...
static uint8_t rgb_both_cached_valid = 0;
static rgb_color rgb_both_cached_color = black;
...
{
    if((rgb_auto_off_enabled == 0) && (rgb_both_cached_valid != 0) && (rgb_both_cached_color == color))
    {
        return;
    }
    ...
    rgb_both_cached_color = color;
    rgb_both_cached_valid = 1;
}
