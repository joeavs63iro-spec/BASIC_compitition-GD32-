   ...
   while(1)
    {
        ...
        oled_show_number(0,0,2023,4,16);
        oled_show_Chinese(32,0,0);
        oled_show_number(48,0,1,1,16);
        oled_show_Chinese(56,0,1);
        oled_show_number(72,0,1,1,16);
        oled_show_Chinese(80,0,2);   //显示年月日

        delay_1ms(1000);	
        oled_clear();
        
        oled_show_string(0,2,"hello world!\0",16);//显示"hello world!"	
        delay_1ms(1000);
        oled_clear();
