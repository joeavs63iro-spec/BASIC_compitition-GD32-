...
#define TCS_DIO2_GPIO_PORT    	GPIOA			              /* GPIOA5 */
#define TCS_DIO2_GPIO_PIN		  GPIO_Pin_5
 
#define TCS_CLK2_GPIO_PORT    	GPIOA		                /* GPIOA6 */
#define TCS_CLK2_GPIO_PIN			GPIO_Pin_6
 
#define TCS_SCL2_H     gpio_bit_output(GPIOA, GPIO_PIN_5, 1)
#define TCS_SCL2_L     gpio_bit_output(GPIOA, GPIO_PIN_5, 0)
#define TCS_SDA2_H     gpio_bit_output(GPIOA, GPIO_PIN_6, 1)
#define TCS_SDA2_L     gpio_bit_output(GPIOA, GPIO_PIN_6, 0)
 
#define TCS_SDA2_READ   gpio_get_input(GPIOA, GPIO_PIN_6)
/******************************************************************************/
