...
// TOF400C激光测距模块管脚宏定义
// TOF400C,SCL和SDA管脚
#define TOF400C_SCL_PORT            GPIOB
#define TOF400C_SCL_PIN             GPIO_PIN_6
#define TOF400C_SDA_PORT            GPIOB
#define TOF400C_SDA_PIN             GPIO_PIN_7
// TOF400C引脚电平操作
#define TOF400C_SCL_LEVEL(level)    gpio_bit_output(TOF400C_SCL_PORT , TOF400C_SCL_PIN , level)
#define TOF400C_SDA_LEVEL(level)    gpio_bit_output(TOF400C_SDA_PORT , TOF400C_SDA_PIN , level)
// TOF400C延时
#define TOF400C_DELAY               1
#define TOF400C_DELAY_MS(time)      (delay_1us(time))
// TOF400C初始化超时次数限制
